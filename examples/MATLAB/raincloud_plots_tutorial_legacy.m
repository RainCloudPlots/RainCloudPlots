...
pardir = pwd;
codedir = [pardir + "\code\matlab\"];
figdir = [pardir + "\figs\mTutorial\"];
datadir = [pardir + "\data\"];
...
print(f2, [figdir + "\2hist.png"], '-dpng')
...
set(gca,'XLim', [0 40]);
box off
print(f3, [figdir + "\3Rain1.png"], '-dpng')
...
set(gca,'XLim', [0 40]);
box off
print(f4, [figdir + "\4Rain2.png"], '-dpng')
...
set(gca,'XLim', [0 40]);
box off
print(f5, [figdir + "\5Rain3.png"], '-dpng')
...
print(f6, [figdir + "\6Rain4.png"], '-dpng')
...
set(gca,'XLim', [0 40]);
box off
print(f7, [figdir + "\7Rain5.png"], '-dpng')
...
print(f8, [figdir + "\8Rain6.png"], '-dpng')
...
print(f9, [figdir + "\9RepRain1.png"], '-dpng')
