...
```{r installpackage, include = TRUE, echo = TRUE}
if (!require(remotes)) {
...
```{r data_1, include = TRUE, echo = TRUE}
df_1x1 <- data_1x1(
...
```{r raincloud_1, include = TRUE, echo = TRUE}
...
```{r, data_2, include = TRUE, echo = TRUE}
df_2x2 <- data_2x2(
  array_1 = iris$Sepal.Length[1:50],
  array_2 = iris$Sepal.Length[51:100],
...
```{r, raincloud_2, include = TRUE, echo = TRUE}
